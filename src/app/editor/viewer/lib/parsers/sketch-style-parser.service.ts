...
export class SketchStyleParserService {
  ...
  private parsePage(obj: any, root: any) {
  ...
  private parseText(obj: any, root: any) {
  ...
  private parseTextFont(obj: any, root: any) {
  ...
  private parseAttributeString(obj: any, root: any) {
  ...
  private parseParagraphStyle(obj: any, root: any) {
  ...
  private parseTextColor(obj: any, root: any) {
    const encodedAttributes = (obj.style.textStyle as SketchMSTextStyle).encodedAttributes;
